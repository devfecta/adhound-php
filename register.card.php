...
/*
	if(isset($UserInfo['UserParentID']))
	{
		...
		if(isset($Users->UserInfoArray['IA_Users_StripeID']) && !empty($UserInfo['IA_Users_StripeID'])) 
		{
...
<th colspan="4">
	...
	<h2 style="margin-left:0px">Billing Address Information</h2>
</th>
</tr>
...
<td style="text-align:right; vertical-align:middle; height:40px" colspan="4">
	* = Required Information 
	...
	<input type="button" onclick="window.location.href='register.php'" name="CancelButton" value="Cancel" />
</td>
</tr>
</table>
</form>
