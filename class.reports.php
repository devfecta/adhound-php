				...
				default:
					...
					if ($AdvertisementCount > 0)
					{
						...
						while ($AdInfo = mysql_fetch_assoc($AdsInfo))
						{
							...
							echo '<h2>'.$AdInfo[IA_Advertisers_BusinessName].'</h2>';
							echo '<a href="reports.php?ReportType=ClientAdListing+'.$UserInfo['IA_Users_ID'].'&AdvertiserID='.$AdInfo[IA_Advertisers_ID].'&ModeType=ViewLocations">[View Locations]</a>';
							...
							for($a=0; $a<count($Ads); $a++) 
							{
								if($Ads[$a]['IA_Ads_Archived'] == 0) 
								{
									...
									if($AdLocationsArray[$l]['IA_Ads_AccountID'] == $Ads[$a]['IA_Ads_AccountID'] && $AdLocationsArray[$l]['IA_LocationRooms_ID'] == $Ads[$a]['IA_LocationRooms_ID']) 
									{
										if($StartDate != null && $EndDate != null) 
										{
											if($UserInfo['IA_Users_Type'] == 1 || isset($UserInfo['Preferences']['Advertisements']['AdDateBasedPricing']))	
											{
												if(ValidateDateRange($StartDate, $EndDate, $Ads[$a]['IA_Ads_StartDate'], $Ads[$a]['IA_Ads_ExpirationDate']))
												{ $AdCount++; }
											}
...
//print("<pre>". print_r($AccountPanelsArray,true) ."</pre>");
			...
			if($Regional)
			{
				...
				if($UserInfo['IA_Users_Type'] == 1 || isset($UserInfo['Preferences']['Locations']['EditRunReports']))	
				{
...
*/
		...
		public function BuildContractRentReport($UserID, $AccountID, $ReportView)
		{
			$Accounts = new _Accounts();
			$Advertisers = new _Advertisers();
			$Advertisements = new _Advertisements();
			...
			switch($ReportView)
			{
				case 'Account':
					...
					echo $Accounts->AccountBusinessName.'\'s Rent Report';
					echo '</div>'."\n";
					$StartDate = $Accounts->AccountStartDate;
					$EndDate = $Accounts->AccountEndDate;
					break;
				case 'Region':
					if($this->RegionID != $Accounts->AccountRegionID) 
					{
						echo '<div id="PageTitle">';
						echo $Accounts->AccountRegionName.'\'s Regional Rent Report';
						echo '</div>'."\n";
			...
			*/
			...
			{
				case 'Account':
					$Reports = mysql_query("SELECT * FROM IA_Reports WHERE IA_Reports_ReportType='".$ReportView."RentReport' AND IA_Reports_AccountID=".$Accounts->AccountID." ORDER BY IA_Reports_TimeStamp DESC", CONN);
					break;
				case 'Region':
					$Reports = mysql_query("SELECT * FROM IA_Reports WHERE IA_Reports_ReportType='".$ReportView."RentReport' AND IA_Reports_AccountID=".$Accounts->AccountRegionID." ORDER BY IA_Reports_TimeStamp DESC", CONN);
					break;
				default:
					break;
			}
		...
		public function ContractRentReport($ReportView, $AccountID, $StartDate, $EndDate)
		{
			...
			for($a=0; $a<=count($AdvertisersArray['Advertisers']); $a++) 
			{
				if(!empty($AdvertisersArray['Advertisers'][$a]['IA_Advertisers_ID'])) 
				{
					...
					if(ValidateDateRange($StartDate, $EndDate, $AdvertisersArray['Advertisers'][$a]['IA_Advertisers_StartDate'], $AdvertisersArray['Advertisers'][$a]['IA_Advertisers_ExpirationDate']))
					{
						$AdvertiserLoopCount++;
						$AllAdsCount = 0;
						$UnpricedAdsCount = 0;
						...
						for($b=0; $b<=count($AdvertisersArray['Advertisers'][$a]['Ads']); $b++) 
						{
							if($AdvertisersArray['Advertisers'][$a]['IA_Advertisers_ApplyToRent'] == 1 && $AdvertisersArray['Advertisers'][$a]['Ads'][$b]['IA_Ads_ApplyRent'] == 1) 
							{
								for($c=0; $c<=count($AdvertisersArray['Advertisers'][$a]['Pricing']); $c++)
								{
									if(!empty($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdvertiserID'])) 
									{
										if($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdNumber'] > 0) 
										{
											$AdLoopCount++;
											if(ValidateDateRange($AdvertisersArray['Advertisers'][$a]['IA_Advertisers_StartDate'], $AdvertisersArray['Advertisers'][$a]['IA_Advertisers_ExpirationDate'], $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_StartDate'], $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_EndDate']))
											{
												$AdPriceLoopCount++;
												if($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdTypeID'] == 0 || $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdTypeID'] == $AdvertisersArray['Advertisers'][$a]['Ads'][$b]['IA_Ads_TypeID']) 
												{ $CountAdType = true; }
												else 
												{ $CountAdType = false; }
												if($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_LocationID'] == 0 || $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_LocationID'] == $AdvertisersArray['Advertisers'][$a]['Ads'][$b]['IA_Ads_LocationID']) 
												{ $CountAdLocation = true; }
												else 
												{ $CountAdLocation = false; }
												if($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdSize'] == 0 || $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdSize'] == $AdvertisersArray['Advertisers'][$a]['Ads'][$b]['IA_AdLibrary_Width'].'x'.$AdvertisersArray['Advertisers'][$a]['Ads'][$b]['IA_AdLibrary_Height']) 
												{ $CountAdSize = true; }
												else 
												{ $CountAdSize = false; }
												...
												if($CountAdType && $CountAdLocation && $CountAdSize) 
												{
													if($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdNumber'] > 0) 
													{
														...
														$AdvertiserContractPricing = $AdvertiserContractPricing + (($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_Pricing'] / $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdNumber']) * CalculateNumberOfIncrements($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_IncrementID'], $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_StartDate'], $AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_EndDate']));
							...
							for($c=0; $c<=count($AdvertisersArray['Advertisers'][$a]['Pricing']); $c++)
							{
								if(!empty($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdvertiserID'])) 
								{
									if($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_AdNumber'] == 0) 
									{
										...
										$AdvertiserUncontractPricing = $AdvertiserUncontractPricing + (($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_Pricing'] / $UnpricedAdsCount) * CalculateNumberOfIncrements($AdvertisersArray['Advertisers'][$a]['Pricing'][$c]['IA_AdvertiserPricing_IncrementID'], $StartDate, $EndDate));
									}
									else 
									{ }	
								}
						...
						$ContractSubTotal = number_format($Accounts->AccountTermsValue * number_format($SubTotalContractPricing, 2, '.', ''), 2, '.', '');
						$UncontractSubTotal = number_format(($Accounts->AccountTermsValue * number_format($AdvertiserUncontractPricing, 2, '.', '')) * $LocationAdsCount, 2, '.', '');
						...
						$this->RentReportRowsArray[$Accounts->AccountID]['Advertisers'][$a]['AdvertiserBusinessName'] = $AdvertisersArray['Advertisers'][$a]['IA_Advertisers_BusinessName'];
						$this->RentReport .= '</div>';
						...
						$this->RentReportRowsArray[$Accounts->AccountID]['Advertisers'][$a]['AdCount'] = $LocationAdsCount;
						$this->RentReport .= '</div>';
						...
						if($Accounts->AccountTermsRate == 'Percentage') 
						{
							...
							$this->RentReportRowsArray[$Accounts->AccountID]['Advertisers'][$a]['SubTotal'] = $SubTotal;
							$Total = $Total + $SubTotal;
						}
						else 
						{
							$this->RentReport .= '$0.00';
							$this->RentReportRowsArray[$Accounts->AccountID]['Advertisers'][$a]['SubTotal'] = '$0.00';
						}
			...
			if($Accounts->AccountTermsRate == 'Percentage') 
			{
				$this->RentReport .= $Accounts->AccountTermsIncrement.' Total $'. number_format($Total, 2, '.', ',');
				$this->RentReportRowsArray[$Accounts->AccountID]['Total'] = $Accounts->AccountTermsIncrement.' Total:'."\t". number_format($Total, 2, '.', ',');
			}
			else 
			{
				$this->RentReport .= $Accounts->AccountTermsIncrement.' Total $'. number_format(($Accounts->AccountTermsValue * CalculateNumberOfIncrements($Accounts->AccountTermsIncrementID, $StartDate, $EndDate)), 2, '.', ',');
				$this->RentReportRowsArray[$Accounts->AccountID]['Total'] = $Accounts->AccountTermsIncrement.' Total:'."\t". number_format(($Accounts->AccountTermsValue * CalculateNumberOfIncrements($Accounts->AccountTermsIncrementID, $StartDate, $EndDate)), 2, '.', ',');
			}
		...
		public function DeleteSavedRentReport($UserID, $AccountID, $ReportID, $FileName) 
		{
			...
			{ $Confirmation = unlink('../users/'.$UserID.'/'.$FileName); }
			else 
			{ $Confirmation = false; }
			return $Confirmation;
		}
