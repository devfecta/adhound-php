...
// Accounts aka Locations
	class _Accounts extends _Validation
	{
		...
		public function AccountList($UserInfo, $AccountID, $RegionID)
		{
			...
			if(($AccountCount < 3 && $UserInfo['IA_Users_Tier'] == 0) || ($AccountCount < 100 && $UserInfo['IA_Users_Tier'] == 1) || ($AccountCount < 200 && $UserInfo['IA_Users_Tier'] == 2) || ($AccountCount < 300 && $UserInfo['IA_Users_Tier'] == 3) || ($AccountCount < 500 && $UserInfo['IA_Users_Tier'] == 4)) 
			{
...
//print("Log<pre>". print_r($LocationInfo[$l]['DamageLogs'],true) ."</pre>");
		...
		public function BuildRegionsForm($RegionID, $ModeType) 
		{
			...
			$RegionForm .= '<input type="text" name="RegionTextBox" size="25" maxlength="50" value="'.$RegionName.'" />';
			$RegionForm .= '</td></tr>';
			$RegionForm .= '<tr style="vertical-align:middle">';
