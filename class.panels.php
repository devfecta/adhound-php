...
//print("<pre>". print_r($Panel,true) ."</pre>");
			if(!empty($Panel)) 
			{
				...
				$PanelLayout = "\n".'<table border="0" cellspacing="0" cellpadding="0" style="box-shadow:5px 5px 5px #aaaaaa; background: url(images/table_background.png) repeat-x; background-color:#ffffff; height:'.$PanelHeight.'px; width:'.$PanelWidth.'px; border:1px solid #555555; margin:0px auto; padding:3px">';
...
//print("<pre>". print_r($AdList,true) ."</pre>");
				...
				for ($Row=1; $Row<=$Panel['IA_Panels_High']; $Row++)
				{
					...
					$SectionLayout = '<table border="1" cellspacing="0" cellpadding="0" style="vertical-align:top; margin:0px">'."\n";
					$SectionLayout .= '<tr>'."\n";
