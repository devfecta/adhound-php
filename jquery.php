...
//print("PricingInfo<pre>". print_r($PricingInfo,true) ."</pre>");
	...
	case 'GetContractRentReport':
		...
		{
			case 'Account':
				$Reports->ContractRentReport($_POST['View'], $_POST['Account'], $_POST['Start'], $_POST['End']);
			...
			case 'Region':
				...
				{
					//echo $LocationCounts++;
					$Reports->ContractRentReport($_POST['View'], $Account['IA_Ads_AccountID'], $_POST['Start'], $_POST['End']);
					echo $Reports->RentReport;
				}
				//mysql_close(CONN);
				break;
