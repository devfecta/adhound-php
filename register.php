...
/*	
$UserInfo['IA_Users_ID'] => 107
$UserInfo['IA_Users_StripeID'] => cus_3EsYAWSZCs9To9
$UserInfo['IA_Users_Username'] => test2
$UserInfo['IA_Users_Password'] => NFpFXmUA4/nqPX/7t1UMpJLPO2L0folfdEcAek+l5s4=
$UserInfo['IA_Users_Type'] => 1
$UserInfo['IA_Users_Tier'] => 1
$UserInfo['IA_Users_BusinessName'] => Test Business 3
$UserInfo['IA_Users_FirstName'] => Kevin
$UserInfo['IA_Users_LastName'] => Kelm
$UserInfo['IA_Users_Address'] => 123 Test Road
$UserInfo['IA_Users_City'] => Markesan
$UserInfo['IA_Users_StateID'] => 6
$UserInfo['IA_Users_Zipcode'] => 12344
$UserInfo['IA_Users_Phone'] => (123) 123-4566
$UserInfo['IA_Users_Fax'] => (123) 456-7891
$UserInfo['IA_Users_Email'] => kkelm@live.com
$UserInfo['IA_Users_RegisteredDate'] => 2014-01-02
$UserInfo['IA_Users_Active'] => 1
$UserInfo['IA_Users_LastLoginDate'] => 2014-01-03
...
*/
	...
	{ 
		if (isset($UserInfo['IA_Users_ID'])) 
		{
			...
			/*
			$Users = new _Users();
			if ($Users->GetUserInfo($UserInfo['IA_Users_ID']))
			{
				$Username = '';
				$BusinessName = $UserInfo['IA_Users_BusinessName'];
				$FirstName = '';
