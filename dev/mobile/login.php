...
*/
	...
	echo 'Message:'.$UserInfo['Users_ID'];
?>
...
<?php
	echo '<link rel="stylesheet" type="text/css" href="../css/mobilestylesheet.css?v='. rand(1, 10) .'" media="only screen and (max-width: 400px)" />'."\n";
...
<div id="Login" style="text-align:center; background-color:#ffffff">
<?php
$image = imagecreatefromgif('../images/AdHound_LogoV.gif');
$color = imagecolorallocate($image, 0, 0, 0);
imagestring($image, 1, 13, 1, VERSION.' Mobile', $color);
