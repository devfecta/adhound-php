...
//$_SESSION['RegistrationInfo']['UsernameTextBoxRequired'] = $UserInfo['Users_Username'];
		...
		$_SESSION['RegistrationInfo']['BusinessNameTextBoxRequired'] = $UserInfo['Users_BusinessName'];
		$_SESSION['RegistrationInfo']['FirstNameTextBoxRequired'] = $UserInfo['Users_FirstName'];
		$_SESSION['RegistrationInfo']['LastNameTextBoxRequired'] = $UserInfo['Users_LastName'];
		$_SESSION['RegistrationInfo']['AddressTextBoxRequired'] = $UserInfo['Users_Address'];
		$_SESSION['RegistrationInfo']['CityTextBoxRequired'] = $UserInfo['Users_City'];
		$_SESSION['RegistrationInfo']['StateDropdownRequired'] = $UserInfo['Users_StateID'];
		$_SESSION['RegistrationInfo']['ZipTextBoxRequired'] = $UserInfo['Users_Zipcode'];
		$_SESSION['RegistrationInfo']['PhoneTextBoxRequired'] = $UserInfo['Users_Phone'];
		$_SESSION['RegistrationInfo']['FaxTextBox'] = $UserInfo['Users_Fax'];
		$_SESSION['RegistrationInfo']['EmailTextBoxRequired'] = $UserInfo['Users_Email'];
		*/
	}
	else 
	{ }
...
*/
	echo ' <input type="button" onclick="window.location.href=\'register.card.php\'" name="EditButton" value="Edit Credit Card Info" />';
	echo '</p>';
	//print("<pre>". print_r($_SESSION['RegistrationInfo'],true) ."</pre>");
?>
</th>
...
if(isset($_SESSION['RegistrationInfo']['StripeCustomerID']) && !empty($_SESSION['RegistrationInfo']['StripeCustomerID'])) 
{
	...
	echo '<button type="submit" class="submit-button" id="RegisterButton" name="RegisterButton" disabled="disabled">Register</button>';
}
/*
if($_SESSION['ModeType'] == 'EditUserAccount') 
{
