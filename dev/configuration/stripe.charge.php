...
if($_SESSION['RegistrationInfo']['TierRadioButton'] > 0) 
{
	...
	try 
	{
		...
		*/
		...
		$Update .= 'Users_Tier="'.$_SESSION['RegistrationInfo']['TierRadioButton'].'"';
		$Update .= ' WHERE Users_StripeID="'.$_SESSION['RegistrationInfo']['StripeCustomerID'].'"';
...
else 
{
	...
	try 
	{
		//if (!isset($_POST['stripeToken']))
		//throw new Exception("The Stripe Token was not generated correctly");
		if($_SESSION['RegistrationInfo']['TierRadioButton'] == 0 && $UserInfo['Users_Tier'] == 0) 
		{
