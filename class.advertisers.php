...
*/
		...
		{
			$Insert = 'INSERT INTO IA_Advertisers (IA_Advertisers_UserID, IA_Advertisers_BusinessName, IA_Advertisers_FirstName, IA_Advertisers_LastName, IA_Advertisers_Address, IA_Advertisers_City, IA_Advertisers_StateID, IA_Advertisers_Zipcode, IA_Advertisers_Phone, IA_Advertisers_Fax, IA_Advertisers_Email, IA_Advertisers_StartDate, IA_Advertisers_ExpirationDate, IA_Advertisers_ApplyToRent, IA_Advertisers_TaxID) VALUES ';
			$Insert .= '(';
			$Insert .= '"'.$UserID.'", ';
...
//print("AdvertiserInfo<pre>". print_r($AdvertiserInfo[$a]['Pricings']['Pricing'],true) ."</pre>");
						if(!empty($AdvertiserInfo[$a]['Pricings']['Pricing'])) 
...
//print("AdSizes<pre>". print_r($AdSizes,true) ."</pre>");
						...
						$AdvertiserList .= "\n".'<div id="AdvertiserPricingTable'.$AdvertiserID.'" name="AdvertiserPricingTable'.$AdvertiserID.'" style="display:block; min-width:100%; text-align:left; vertical-align:top">';
...
//print("PricingInfo<pre>". print_r($PricingInfo,true) ."</pre>");
			...
			$AdvertiserPricingList .= '<div style="width:auto; clear:both" />';
			
			if(count($PricingInfo) > 0) 
			{
				$RowCount = 0;
				for($p=0; $p<count($PricingInfo); $p++) 
				{
					...
					{
						$AdvertiserPricingList .= '<div style="width:150px; display:inline-block; float:left; width:auto; text-align:left">';
						...
						$AdvertiserPricingList .= '<div style="width:80px; display:inline-block float:left;; width:auto; text-align:left">';
						...
						$AdvertiserPricingList .= '<div style="width:120px; padding-right:10px; display:inline-block; float:left; width:auto; text-align:left">';
...
//echo 'AdvID:'.$PricingInfo[$p]['IA_AdvertiserPricing_AdvertiserID'];
						...
						$AdvertiserPricingList .= '<div style="width:40px; display:inline-block; float:left; width:auto; text-align:center">';
						...
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:90px; display:inline-block; float:left; width:auto; text-align:right">';
						...
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:120px; display:inline-block; float:left; width:auto; text-align:right">';
						...
						$AdvertiserPricingList .= '</select>'."\n";
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:100px; display:inline-block; float:left; width:auto; text-align:center">';
						...
						$AdvertiserPricingList .= '</select>'."\n";
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:100px; display:inline-block; float:left; text-align:center">';
						...
						$AdvertiserPricingList .= '</select>'."\n";
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:100px; display:inline-block; float:left; width:auto; text-align:right">';
					...
					{
						$AdvertiserPricingList .= '<div style="width:150px; display:inline-block; float:left; text-align:left; vertical-align:middle">';
						$AdvertiserPricingList .= $PricingInfo[$p]['IA_AdLocations_Location'];
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:80px; display:inline-block; float:left; text-align:left; vertical-align:middle">';
						$AdvertiserPricingList .= $PricingInfo[$p]['IA_AdTypes_Name'];
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:120px; display:inline-block; float:left; text-align:left; vertical-align:middle">';
						if($PricingInfo[$p]['IA_AdvertiserPricing_AdSize'] != '0x0') 
						{
							$AdDimensions = explode("x", $PricingInfo[$p]['IA_AdvertiserPricing_AdSize']);
						...
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:40px; display:inline-block; float:left; text-align:center; vertical-align:middle">';
						$AdvertiserPricingList .= $PricingInfo[$p]['IA_AdvertiserPricing_AdNumber'];
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:90px; padding-right:10px; display:inline-block; float:left; text-align:right; vertical-align:middle">';
						$AdvertiserPricingList .=  '$'. number_format($PricingInfo[$p]['IA_AdvertiserPricing_Pricing'], 2, '.', ',');
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:120px; display:inline-block; float:left; text-align:center; vertical-align:middle">';
//echo 'Inc:'.$PricingInfo[$p]['IA_AdvertiserPricing_IncrementID'];
						...
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:100px; display:inline-block; float:left; text-align:center; vertical-align:middle">';
						...
						$AdvertiserPricingList .= '</div>';
						$AdvertiserPricingList .= '<div style="width:100px; display:inline-block; float:left; text-align:right; vertical-align:middle">';
